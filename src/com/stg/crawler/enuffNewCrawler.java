...
public class enuffNewCrawler implements ServiceInterface {

	
	
	@Override
	public ArrayList<String> excute() throws Exception {
		String url = "http://enuffnuff.com/product/list.html?cate_no=43&page=1";
		...
		for(int i = 1; i <= idx; i++) {
			String URL = "http://enuffnuff.com/product/list.html?cate_no=43&page="+i;
