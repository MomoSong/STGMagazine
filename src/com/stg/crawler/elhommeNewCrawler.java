...
public class elhommeNewCrawler implements ServiceInterface {

	
	
	@Override
	public ArrayList<String> excute() throws Exception {
		String url = "http://www.el-homme.com/product/list.html?cate_no=63&page=1";
		...
		for(int i = 1; i <= idx; i++) {
			String URL = "http://www.el-homme.com/product/list.html?cate_no=63&page="+i;
