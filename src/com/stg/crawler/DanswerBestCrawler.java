...
public class DanswerBestCrawler implements ServiceInterface {

	
	
	@Override
	public ArrayList<String> excute() throws Exception {
		String url = "http://www.d-answer.com/shop/shopbrand.html?type=P&xcode=028&sort=&page=1";
		...
		for(int i = 1; i <= idx; i++) {
			String URL = "http://www.d-answer.com/shop/shopbrand.html?type=P&xcode=028&sort=&page="+i;
